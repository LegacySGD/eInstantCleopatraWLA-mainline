...
public class CleopatraWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CleopatraWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CleopatraWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CleopatraWLAIW/InitOutcome.xml").getDocumentElement();
